          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                ...
                <Input id="states-n" required type="number" inputMode="numeric" min="1" value={n} onFocus={(e) => e.target.select()} onChange={(e) => setN(e.target.value === "" ? "" : parseInt(e.target.value) || 1)} autoComplete="off" autoCorrect="off" spellCheck={false} />
              </div>
              <div className="space-y-2">
                ...
                <Input id="inputs-m" required type="number" inputMode="numeric" min="1" value={m} onFocus={(e) => e.target.select()} onChange={(e) => setM(e.target.value === "" ? "" : parseInt(e.target.value) || 1)} autoComplete="off" autoCorrect="off" spellCheck={false} />
              </div>
              <div className="space-y-2">
                ...
                <Input id="outputs-p" required type="number" inputMode="numeric" min="1" value={p} onFocus={(e) => e.target.select()} onChange={(e) => setP(e.target.value === "" ? "" : parseInt(e.target.value) || 1)} autoComplete="off" autoCorrect="off" spellCheck={false} />
              </div>
              <div className="space-y-2">
                ...
                <Input id="disturbances-q" required type="number" inputMode="numeric" min="1" value={q} onFocus={(e) => e.target.select()} onChange={(e) => setQ(e.target.value === "" ? "" : parseInt(e.target.value) || 1)} autoComplete="off" autoCorrect="off" spellCheck={false} />
              </div>
            </div>
          </CardContent>
        </Card>
