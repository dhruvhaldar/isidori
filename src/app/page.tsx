  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        <Card className="h-full transition-colors hover:bg-muted/50 active:scale-[0.98] has-[:focus-visible]:bg-muted/50 cursor-pointer relative group has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-ring has-[:focus-visible]:ring-offset-2 rounded-xl">
          <CardHeader>
        ...
        <Card className="h-full transition-colors hover:bg-muted/50 active:scale-[0.98] has-[:focus-visible]:bg-muted/50 cursor-pointer relative group md:col-span-2 lg:col-span-1 has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-ring has-[:focus-visible]:ring-offset-2 rounded-xl">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
